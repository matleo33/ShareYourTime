                            ...
                            <div class="col-sm-9">
                                <div class="col-sm-12">
                                    <form method="post" action="getAvis.php">
                                        <div class="row">
                                            <div class="stars col">
                                                <input class="star star-5" name="star-5" id="star-5" type="radio" name="star"/>
                                                <label class="star star-5" for="star-5"></label>
                                                <input class="star star-4" name="star-4" id="star-4" type="radio" name="star"/>
                                                <label class="star star-4" for="star-4"></label>
                                                <input class="star star-3" name="star-3" id="star-3" type="radio" name="star"/>
                                                <label class="star star-3" for="star-3"></label>
                                                <input class="star star-2" name="star-2" id="star-2" type="radio" name="star"/>
                                                <label class="star star-2" for="star-2"></label>
                                                <input class="star star-1" name="star-1" id="star-1" type="radio" name="star"/>
