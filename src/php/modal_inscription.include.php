    ...
    <div class="modal-dialog modal-sm">
        ...
        <div class="modal-content">
            ...
            <form method="post" action="traiter_inscription.php">
                ...
                <div class="form-group col-sm-10 col-sm-offset-1">
                    <input type="email" class="form-control" id="inputMail" name="inputMail" placeholder="prenom.nom@etu.u-bordeaux.fr" required>
                </div>
                <div class="form-group col-sm-10 col-sm-offset-1">
                ...
                <div class="form-group col-sm-6">
                    <input type="text" class="form-control" id="inputType" name="inputType" placeholder="Type rue" required>
                </div>
                <div class="form-group col-sm-10 col-sm-offset-1">
                ...
                <div class="form-group col-sm-6">
                    <input type="text" class="form-control" id="inputCity" name="inputCity" placeholder="Ville" required>
                </div>
                <div class="form-group col-sm-10 col-sm-offset-1">
